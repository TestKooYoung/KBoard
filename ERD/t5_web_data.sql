-- 기존테이블 내용 삭제
# 테이블 내용 삭제 할때 자식관련 테이블 부터 먼저 삭제.
...
# 샘플 user
INSERT INTO
    t5_user (username, password, name, email)
VALUES
    ('USER1', '$2a$10$3TtI98GFz.QrTwI/JS063u.3YGMEhB.zhJcfjPxsJj7oSU2lmICNS', '회원1', 'user1@mail.com'),
    ('USER2', '$2a$10$W.Ir3o6wlcTsimUoaXzM4OnvZNSq9yvKc2yupr4l.SisUo3l/0yBm', '회원2', 'user2@mail.com'),
    ('ADMIN1', '$2a$10$pusjO211RM/xV16ujJPcqutzjpqcNL4QhDSBoLh5DiUntVRyfkakG', '관리자1', 'admin1@mail.com')
;
...
-- 샘플 글
INSERT INTO
    t5_post (user_id, subject, content)
VALUES
    (1, '제목입니다1', '내용입니다1'),
    (1, '제목입니다2', '내용입니다2'),
    (3, '제목입니다3', '내용입니다3'),
...
-- 샘플 댓글
INSERT INTO
    t5_comment(user_id, post_id, content)
VALUES
...
-- 샘플 첨부파일
INSERT INTO
    t5_attachment(post_id, sourcename, filename)
VALUES
