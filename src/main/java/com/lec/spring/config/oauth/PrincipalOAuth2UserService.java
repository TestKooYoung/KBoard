...
public class PrincipalOAuth2UserService extends DefaultOAuth2UserService {
    //DefaultOAuth2UserService 상속 받음
    // 인증후 '후처리' 를 작성
...
//    @Autowired
//    private PasswordEncoder passwordEncoder; // 회원가입시 pw 인코딩
//
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        String provider = userRequest.getClientRegistration().getRegistrationId(); // ex) "google" / provider.
        ...
        String username = provider + "_" + providerId; // ex) "google_xxxxx" 형태
