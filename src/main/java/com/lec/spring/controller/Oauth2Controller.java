...
public class Oauth2Controller {
    ...
    public KakaoOAuthToken kakaoAccessToken(String code){
        ...
        // 카카오 서버 쪽으로 post 방식 요청 key-value
        ...
        // 첫번째 매개변수로 json 문자열, 두번째 매개변수 KakaoOAuthToken.class
            System.out.println("카카오 access toeken : " + token.getAccess_token());
            // AccessToken 확인
